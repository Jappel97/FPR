...
public class SlimeBehavior : Behavior
{
    ...
    void Update()
    {
        if (Singleton.Players.Count > 0)
        {
            ...
            this.transform.rotation = Quaternion.Euler(this.transform.rotation.eulerAngles.x, this.transform.rotation.eulerAngles.y + 90, this.transform.rotation.eulerAngles.z);
        }
    }
